...
namespace Quartz
{
    ...
    public interface ISchedulerFactory
	{
		...
		/// </summary>
		Task<IReadOnlyList<IScheduler>> GetAllSchedulers(CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </summary>
        Task<IScheduler> GetScheduler(string schedName, CancellationToken cancellationToken = default(CancellationToken));
	}
}