...
internal sealed class TriggerWrapper : IEquatable<TriggerWrapper>
{
    ...
    public bool Equals(TriggerWrapper? other) => other != null && other.TriggerKey.Equals(TriggerKey);
    ...
    /// </returns>
    public override bool Equals(object? obj) => Equals(obj as TriggerWrapper);
    ...
    /// </returns>
    public override int GetHashCode() => TriggerKey.GetHashCode();
}