...
namespace Quartz.Impl.AdoJobStore
{
    ...
    public class UpdateLockRowSemaphoreMOT : DBSemaphore
    {
        public static readonly string SqlUpdateForLock =
            string.Format(CultureInfo.InvariantCulture, "UPDATE {0}{1} WITH (SNAPSHOT) SET {2} = {3} WHERE {4} = {5} AND {6} = @lockName",
