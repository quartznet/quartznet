...
CREATE TABLE IF NOT EXISTS {0}TRIGGERS (
  ...
  CONTINUES_TRIGGER_NAME VARCHAR(200) NULL,
  CONTINUES_TRIGGER_GROUP VARCHAR(200) NULL,
...
CREATE TABLE IF NOT EXISTS {0}EXECUTION_HISTORY (
  ...
  PRIMARY KEY (SCHED_NAME,ENTRY_ID),
  KEY IDX_{1}EH_FIRED_TIME (SCHED_NAME,FIRED_TIME),
  KEY IDX_{1}EH_INST (SCHED_NAME,INSTANCE_NAME)
) ENGINE=InnoDB;
--;;
-- {0}MISFIRE_HISTORY
CREATE TABLE IF NOT EXISTS {0}MISFIRE_HISTORY (
  ...
  PRIMARY KEY (SCHED_NAME,ENTRY_ID),
  KEY IDX_{1}MH_MISFIRE_TIME (SCHED_NAME,MISFIRE_TIME),
  KEY IDX_{1}MH_INST (SCHED_NAME,INSTANCE_NAME)
) ENGINE=InnoDB;
