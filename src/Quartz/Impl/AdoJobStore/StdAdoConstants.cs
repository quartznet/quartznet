...
namespace Quartz.Impl.AdoJobStore
{
	...
	public class StdAdoConstants
	{
		...
		static StdAdoConstants()
		{
			...
			UPDATE_SCHEDULER_STATE = string.Format("UPDATE {0}{1} SET {2} = ? WHERE {3} = ?", StdAdoConstants.TABLE_PREFIX_SUBST, AdoConstants.TABLE_SCHEDULER_STATE, AdoConstants.COL_LAST_CHECKIN_TIME, AdoConstants.COL_INSTANCE_NAME);
