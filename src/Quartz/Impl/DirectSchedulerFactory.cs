...
namespace Quartz.Impl
{
    ...
    public class DirectSchedulerFactory : ISchedulerFactory
    {
        ...
        /// <summary>
        /// Creates a scheduler using the specified Name. This
        ...
        /// </summary>
        public virtual void CreateScheduler(string schedulerName)
        {
            IThreadPool threadPool = new DefaultThreadPool();
            threadPool.Initialize();
            IJobStore jobStore = new RAMJobStore();
            CreateScheduler(schedulerName, DefaultInstanceId, threadPool, jobStore);
        }
