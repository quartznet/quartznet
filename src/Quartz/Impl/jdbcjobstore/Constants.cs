...
namespace Quartz.impl.jdbcjobstore
{
	...
	{
		//UPGRADE_NOTE: Members of interface 'Constants' were extracted into structure 'Constants_Fields'. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1045_3"'
