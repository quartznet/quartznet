...
namespace Quartz.impl.jdbcjobstore
{
	...
	public interface DriverDelegate
	{
		...
		*/
		...
		/// </summary>
		//UPGRADE_NOTE: There are other database providers or managers under System.Data namespace which can be used optionally to better fit the application requirements. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1208_3"'
		JobDetail selectJobDetail(OleDbConnection conn, string jobName, string groupName, ClassLoadHelper loadHelper);
		...
		/// </returns>
		//UPGRADE_NOTE: There are other database providers or managers under System.Data namespace which can be used optionally to better fit the application requirements. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1208_3"'
		JobDetail selectJobForTrigger(OleDbConnection conn, string triggerName, string groupName, ClassLoadHelper loadHelper);
		...
		//UPGRADE_NOTE: There are other database providers or managers under System.Data namespace which can be used optionally to better fit the application requirements. 'ms-help://MS.VSCC.2003/commoner/redir/redirect.htm?keyword="jlca1208_3"'
		SupportClass.SetSupport selectPausedTriggerGroups(OleDbConnection conn);
