...
namespace Quartz.Impl.Triggers
{
    ...
    public abstract class AbstractTrigger : IOperableTrigger, IEquatable<AbstractTrigger>
    {
        ...
        {
            get { return key ?? (key = new TriggerKey(Name, Group)); }
        ...
        public virtual DateTimeOffset StartTimeUtc
        {
            ...
            set
            {
                ...
                startTimeUtc = !HasMillisecondPrecision ? new DateTime(value.Year, value.Month, value.Day, value.Hour, value.Minute, value.Second) : value;
            }
        }
