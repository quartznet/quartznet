...
namespace Quartz.Util
{
    ...
    public static class ObjectUtils
    {
        ...
        public static object ConvertValueIfNecessary(Type requiredType, object newValue)
        {
            ...
            return requiredType.IsValueType ? Activator.CreateInstance(requiredType) : newValue;
            // return default
        }
        ...
        public static void SetPropertyValue(object target, string propertyName, object value)
        {
            ...
            value = mi.GetParameters()[0].ParameterType == typeof(TimeSpan) ? GetTimeSpanValueForProperty(pi, value) : ConvertValueIfNecessary(mi.GetParameters()[0].ParameterType, value);
