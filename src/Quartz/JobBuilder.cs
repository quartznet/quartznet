...
namespace Quartz
{
    ...
    public class JobBuilder<T> : JobBuilder where T : IJob
    {
        ...
        {
            JobBuilder<T> b = new JobBuilder<T>();
            b.OfType<T>();
            return b;
        }
        ...
        /// </summary>
        /// <returns>a new JobBuilder</returns>
        private new JobBuilder<T1> Create<T1>() where T1 : IJob
        {
            JobBuilder<T1> b = new JobBuilder<T1>();
            b.OfType(typeof(T1));
            return b;
        }
        ...
        /// <returns>a new JobBuilder</returns>
        [Obsolete]
        private new JobBuilder<T1> CreateForAsync<T1>() where T1 : IJob
        {
            JobBuilder<T1> b = new JobBuilder<T1>();
            b.OfType(typeof(T1));
            return b;
        ...
        public JobBuilder<T> UsingJobData(Action<T> ctor)
        {
            ...
            var original = (T)constructor.Invoke(null);
            var temp = (T)constructor.Invoke(null);
            ctor.Invoke(temp);
