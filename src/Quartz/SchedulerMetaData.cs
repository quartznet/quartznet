...
namespace Quartz
{
    ...
    public class SchedulerMetaData
    {
        ...
        public string GetSummary()
        {
            ...
            str.Append("'");
            str.Append(SchedulerRemote ? " - access via remote incovation." : " - running locally.");
            str.Append("\n");
            ...
            if (!Shutdown)
            {
                ...
                str.Append(InStandbyMode ? "  Currently in standby mode." : "  Not currently in standby mode.");
            }
            else
            {
            ...
            str.Append("' - which ");
            str.Append(JobStoreSupportsPersistence ? "supports persistence." : "does not support persistence.");
            str.Append(JobStoreClustered ? " and is clustered." : " and is not clustered.");
            str.Append("\n");
