...
// The top-level groups are the current release. 4.x is what a reader lands on, so its pages are the
// unlabelled groups here; 3.x is the maintained line and sits in a collapsed group of its own above
// "Old Releases", which is where the lines nobody ships against live.
export const sidebarEn: SidebarConfig = [
    ...
    children: [
      ...
      "/documentation/quartz-4.x/quick-start",
      {
        ...
        children: [
          ...
          "/documentation/quartz-4.x/tutorial/job-data-map",
          "/documentation/quartz-4.x/tutorial/more-about-triggers",
          "/documentation/quartz-4.x/tutorial/querying-jobs-and-triggers",
      ...
      "/documentation/quartz-4.x/log-events",
  ...
  },
  {
    ...
    children: [
      ...
      "/documentation/quartz-4.x/how-tos/coming-from-hangfire",
      "/documentation/quartz-4.x/how-tos/coming-from-tickerq",
      ...
      "/documentation/quartz-4.x/how-tos/lock-handler",
    ],
  },
  {
    text: "Packages",
        ...
        children: [
          "/documentation/quartz-3.x/quick-start",
          {
            ...
            children: [
              ...
              "/documentation/quartz-3.x/tutorial/execution-groups",
              "/documentation/quartz-3.x/tutorial/node-affinity",
