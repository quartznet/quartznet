...
export const sidebarEn: SidebarConfig = [
    {
        ...
        children: [
            ...
            { text: 'API Documentation', link: 'http://quartznet.sourceforge.net/apidoc/3.0/html' },
        ...
        children: [
            {
                ...
                children: [
                    ...
                    { link: 'http://quartznet.sourceforge.net/apidoc/2.0/html', text: 'API Documentation' },
                ]
            },
            {
                text: 'Quartz 1.x',
                ...
                children: [
                    ...
                    { link: 'http://quartznet.sourceforge.net/apidoc/1.0/html', text: 'API Documentation' },
                ]
            },
        ]
    },
