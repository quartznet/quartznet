...
To build an expression from user input, use the fluent `CronExpressionBuilder`:
...
The full API is in the tutorial, under [Building cron expressions programmatically](../tutorial/crontrigger.md#building-cron-expressions-programmatically).
