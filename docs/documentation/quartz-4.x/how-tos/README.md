...
* [Job Continuations](job-continuations.md) — run a trigger when another trigger's firing ends, and only on the outcomes you name
...
* [Coming from TickerQ](coming-from-tickerq.md) — the same, shorter
