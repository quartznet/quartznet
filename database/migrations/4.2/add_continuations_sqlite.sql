...
--        ../4.0/schema_30_to_40_upgrade_sqlite.sql first; this file is what 4.2 adds
--        on top of it.
--
...
ALTER TABLE QRTZ_TRIGGERS ADD COLUMN CONTINUES_TRIGGER_NAME NVARCHAR(150) NULL;

ALTER TABLE QRTZ_TRIGGERS ADD COLUMN CONTINUES_TRIGGER_GROUP NVARCHAR(150) NULL;
