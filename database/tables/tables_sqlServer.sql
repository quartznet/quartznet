...
--Drop with existing
IF EXISTS (SELECT * FROM sys.indexes AS si WHERE si.[name] = 'IDX_QRTZ_T_G_J')
	BEGIN
...
IF EXISTS (SELECT * FROM sys.indexes AS si WHERE si.[name] = 'IDX_QRTZ_T_C')
	BEGIN
...
IF EXISTS (SELECT * FROM sys.indexes AS si WHERE si.[name] = 'IDX_QRTZ_T_N_G_STATE')
	BEGIN
...
IF EXISTS (SELECT * FROM sys.indexes AS si WHERE si.[name] = 'IDX_QRTZ_T_STATE')
	BEGIN
...
IF EXISTS (SELECT * FROM sys.indexes AS si WHERE si.[name] = 'IDX_QRTZ_T_N_STATE')
	BEGIN
...
IF EXISTS (SELECT * FROM sys.indexes AS si WHERE si.[name] = 'IDX_QRTZ_T_NEXT_FIRE_TIME')
	BEGIN
...
IF EXISTS (SELECT * FROM sys.indexes AS si WHERE si.[name] = 'IDX_QRTZ_T_NFT_ST')
	BEGIN
...
IF EXISTS (SELECT * FROM sys.indexes AS si WHERE si.[name] = 'IDX_QRTZ_T_NFT_ST_MISFIRE')
	BEGIN
...
IF EXISTS (SELECT * FROM sys.indexes AS si WHERE si.[name] = 'IDX_QRTZ_T_NFT_ST_MISFIRE_GRP')
	BEGIN
...
IF EXISTS (SELECT * FROM sys.indexes AS si WHERE si.[name] = 'IDX_QRTZ_FT_INST_JOB_REQ_RCVRY')
	BEGIN
...
IF EXISTS (SELECT * FROM sys.indexes AS si WHERE si.[name] = 'IDX_QRTZ_FT_G_J')
	BEGIN
...
IF EXISTS (SELECT * FROM sys.indexes AS si WHERE si.[name] = 'IDX_QRTZ_FT_G_T')
	BEGIN
