...
BEGIN
    ...
    IF OBJECT_ID(N'[dbo].[QRTZ_EXECUTION_HISTORY]', N'U') IS NOT NULL
    DROP TABLE [dbo].[QRTZ_EXECUTION_HISTORY];

    IF OBJECT_ID(N'[dbo].[QRTZ_MISFIRE_HISTORY]', N'U') IS NOT NULL
    DROP TABLE [dbo].[QRTZ_MISFIRE_HISTORY];
...
ALTER TABLE [dbo].[QRTZ_EXECUTION_HISTORY] WITH NOCHECK ADD
  CONSTRAINT [PK_QRTZ_EXECUTION_HISTORY] PRIMARY KEY  CLUSTERED
  (
    [SCHED_NAME],
    [ENTRY_ID]
  );
...
ALTER TABLE [dbo].[QRTZ_MISFIRE_HISTORY] WITH NOCHECK ADD
  CONSTRAINT [PK_QRTZ_MISFIRE_HISTORY] PRIMARY KEY  CLUSTERED
  (
    [SCHED_NAME],
    [ENTRY_ID]
  );
