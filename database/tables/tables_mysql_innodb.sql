...
SET @DropQuartzTablesSql = IF(@DropDb = 1,
  'DROP TABLE IF EXISTS QRTZ_FIRED_TRIGGERS, QRTZ_PAUSED_TRIGGER_GRPS, QRTZ_PAUSED_JOB_GRPS, QRTZ_SCHEDULER_STATE, QRTZ_LOCKS, QRTZ_SIMPLE_TRIGGERS, QRTZ_SIMPROP_TRIGGERS, QRTZ_CRON_TRIGGERS, QRTZ_BLOB_TRIGGERS, QRTZ_TRIGGERS, QRTZ_JOB_DETAILS, QRTZ_CALENDARS, QRTZ_EXECUTION_HISTORY, QRTZ_MISFIRE_HISTORY',
  'DO 0');
