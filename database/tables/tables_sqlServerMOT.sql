...
IF OBJECT_ID(N'[dbo].[QRTZ_CALENDARS]', N'U') IS NOT NULL AND NOT EXISTS(SELECT TOP 1 * FROM [dbo].[QRTZ_CALENDARS])
BEGIN
DROP TABLE [dbo].[QRTZ_CALENDARS];
GO
END

IF OBJECT_ID(N'[dbo].[QRTZ_CRON_TRIGGERS]', N'U') IS NOT NULL AND NOT EXISTS(SELECT TOP 1 * FROM [dbo].[QRTZ_CRON_TRIGGERS])
BEGIN
...
IF OBJECT_ID(N'[dbo].[QRTZ_BLOB_TRIGGERS]', N'U') IS NOT NULL AND NOT EXISTS(SELECT TOP 1 * FROM [dbo].[QRTZ_BLOB_TRIGGERS])
BEGIN
DROP TABLE [dbo].[QRTZ_BLOB_TRIGGERS];
GO
END

IF OBJECT_ID(N'[dbo].[QRTZ_FIRED_TRIGGERS]', N'U') IS NOT NULL AND NOT EXISTS(SELECT TOP 1 * FROM [dbo].[QRTZ_FIRED_TRIGGERS])
BEGIN
DROP TABLE [dbo].[QRTZ_FIRED_TRIGGERS];
GO
END

IF OBJECT_ID(N'[dbo].[QRTZ_PAUSED_TRIGGER_GRPS]', N'U') IS NOT NULL AND NOT EXISTS(SELECT TOP 1 * FROM [dbo].[QRTZ_PAUSED_TRIGGER_GRPS])
BEGIN
DROP TABLE [dbo].[QRTZ_PAUSED_TRIGGER_GRPS];
GO
END

IF  OBJECT_ID(N'[dbo].[QRTZ_JOB_LISTENERS]', N'U') IS NOT NULL AND NOT EXISTS(SELECT TOP 1 * FROM [dbo].[QRTZ_JOB_LISTENERS])
BEGIN
...
IF OBJECT_ID(N'[dbo].[QRTZ_SCHEDULER_STATE]', N'U') IS NOT NULL AND NOT EXISTS(SELECT TOP 1 * FROM [dbo].[QRTZ_SCHEDULER_STATE])
BEGIN
DROP TABLE [dbo].[QRTZ_SCHEDULER_STATE];
GO
END

IF OBJECT_ID(N'[dbo].[QRTZ_LOCKS]', N'U') IS NOT NULL AND NOT EXISTS(SELECT TOP 1 * FROM [dbo].[QRTZ_LOCKS])
begin
DROP TABLE [dbo].[QRTZ_LOCKS];
GO
end

IF OBJECT_ID(N'[dbo].[QRTZ_TRIGGER_LISTENERS]', N'U') IS NOT NULL AND NOT EXISTS(SELECT TOP 1 * FROM [dbo].[QRTZ_TRIGGER_LISTENERS])
BEGIN
...
IF OBJECT_ID(N'[dbo].[QRTZ_JOB_DETAILS]', N'U') IS NOT NULL AND NOT EXISTS(SELECT TOP 1 * FROM [dbo].[QRTZ_JOB_DETAILS])
BEGIN
...
IF OBJECT_ID(N'[dbo].[QRTZ_SIMPLE_TRIGGERS]', N'U') IS NOT NULL AND NOT EXISTS(SELECT TOP 1 * FROM [dbo].[QRTZ_SIMPLE_TRIGGERS])
BEGIN
...
IF OBJECT_ID(N'[dbo].[QRTZ_SIMPROP_TRIGGERS]', N'U') IS NOT NULL AND NOT EXISTS(SELECT TOP 1 * FROM [dbo].[QRTZ_SIMPROP_TRIGGERS])
BEGIN
...
IF OBJECT_ID(N'[dbo].[QRTZ_TRIGGERS]', N'U') IS NOT NULL AND NOT EXISTS(SELECT TOP 1 * FROM [dbo].[QRTZ_TRIGGERS])
BEGIN
