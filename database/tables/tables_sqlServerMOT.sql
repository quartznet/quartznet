...
BEGIN
  ...
  IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[QRTZ_EXECUTION_HISTORY]') AND OBJECTPROPERTY(id, N'ISUSERTABLE') = 1)
  DROP TABLE [dbo].[QRTZ_EXECUTION_HISTORY];

  IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[QRTZ_MISFIRE_HISTORY]') AND OBJECTPROPERTY(id, N'ISUSERTABLE') = 1)
  ...
  IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[QRTZ_PAUSED_JOB_GRPS]') AND OBJECTPROPERTY(id, N'ISUSERTABLE') = 1)
...
-- this schema references them. Ordinary tables, as everything but QRTZ_LOCKS is here.
