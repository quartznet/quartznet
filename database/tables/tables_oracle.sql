...
CREATE TABLE qrtz_triggers
  (
    ...
    CONTINUES_TRIGGER_NAME VARCHAR2(200) NULL,
    CONTINUES_TRIGGER_GROUP VARCHAR2(200) NULL,
    CONTINUATION_CONDITION NUMBER(13) NULL,
    JOB_DATA BLOB NULL,
...
CREATE TABLE qrtz_fired_triggers 
  (
    ...
    EXECUTION_GROUP VARCHAR2(200) NULL,
    PROGRESS NUMBER(13) NULL,
    PROGRESS_MESSAGE VARCHAR2(1000) NULL,
